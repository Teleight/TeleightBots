...
public sealed interface EventListener<T extends Event> permits EventListenerImpl {
    ...
    ///
    /// @return The [Class] object representing the type of event this listener is for.
    @NotNull Class<T> eventType();

    /// Executes the event handler with the given event.
    ///
    /// @param event The event to be handled by the listener.
    /// @return The result of processing the event, as defined by the [Result] enumeration.
    ...
    ///
    /// @param <T> The type of event that the [EventListener] being built will handle.
    sealed interface Builder<T extends Event> permits EventListenerImpl.BuilderImpl {
        ...
        ///
        /// @param filter The [Predicate] used to filter events.
        ...
        ///
        /// @param handler The [Consumer] that processes the events.
        /// @return The current Builder instance.
        ...
        /// before it is discarded and marked as `EXPIRED`.
        ///
        ...
        ///
        /// @return A new [EventListener] instance with the configured properties.

...
public record WebhookBotSettings(
    ...
    /// Creates a new [Builder] instance with the specified webhook URL.
    ///
    /// @param url  the webhook URL for registering with Telegram. Cannot be `null`.
    /// @param path the URL path on your server where the webhook will be received. Cannot be `null`.
    /// @return a new [Builder] instance pre-configured with the provided URL
    ...
    /// @param url  the webhook URL for registering with Telegram. Cannot be `null`.
    /// @param path the URL path on your server where the webhook will be received. Cannot be `null`.
    /// @return a new [WebhookBotSettings] instance
    /// @throws NullPointerException if the `url` is `null`

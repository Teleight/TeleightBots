...
public record SendLivePhoto(
    ...
    public static @NotNull Builder ofBuilder(String chatId, InputFile livePhoto, InputFile photo) {
        return new SendLivePhoto.Builder()
                .chatId(chatId)
                .livePhoto(livePhoto)
                .photo(photo);
    }
    ...
    public @NotNull Map<String, Object> getParameters() {
        ...
        parameters.put("live_photo", livePhoto);
